...
const comparisonData: ComparisonCategory[] = [
  {
    ...
    totalNum: 185590,
    items: [
      { key: 'ranteavdrag', amount: '61.0 mdr', amountNum: 61000, source: 'ESV (separat beräkning), via SVT 2024-12-28' },
      { key: 'avkastningHem', amount: '28.7 mdr', amountNum: 28690, source: 'Skr. 2024/25:98, post C1' },
      { key: 'fastighetsskatt', amount: '~28.0 mdr', amountNum: 28000, source: 'Finanspolitiska rådet + SNS Konjunkturrådet' },
      { key: 'tolvregler', amount: '12.9 mdr', amountNum: 12910, source: 'Skr. 2024/25:98, post C4; RiR 2021:17' },
      { key: 'rot', amount: '12.3 mdr', amountNum: 12320, source: 'Skr. 2024/25:98, post G4; SCB HEK' },
      { key: 'rut', amount: '8.2 mdr', amountNum: 8200, source: 'Skr. 2024/25:98, post G3; Skatteverket' },
      { key: 'kapitalvinstBostad', amount: '7.3 mdr', amountNum: 7300, source: 'Skr. 2024/25:98, post C7' },
      { key: 'formogenhetsskatt', amount: '~7.0 mdr', amountNum: 7000, source: 'Finansdepartementet historiska siffror + SCB' },
      { key: 'avkastningBrf', amount: '6.4 mdr', amountNum: 6430, source: 'Skr. 2024/25:98, post C2' },
      { key: 'miljobilar', amount: '4.7 mdr', amountNum: 4710, source: 'Skr. 2024/25:98, post A15' },
      { key: 'arvsskatt', amount: '~3.5 mdr', amountNum: 3500, source: 'Finansdepartementet historiska siffror' },
      { key: 'uppskov', amount: '2.5 mdr', amountNum: 2510, source: 'Skr. 2024/25:98, post C6' },
      { key: 'onoterade', amount: '2.0 mdr', amountNum: 2020, source: 'Skr. 2024/25:98, post C3' },
      { key: 'expertskatt', amount: '1.0 mdr', amountNum: 1000, source: 'ESV, skr. 2024/25:98' },
    ],
  },
  {
    catKey: 'poor',
    ...
    totalNum: 53120,
    items: [
      { key: 'ekonomisktBistand', amount: '~15.5 mdr', amountNum: 15500, source: 'Socialstyrelsen, SoL kap 4 §1' },
      { key: 'bostadstillagg', amount: '~10.5 mdr', amountNum: 10500, source: 'Pensionsmyndigheten; SFB kap 101–103' },
      { key: 'aldreforsorjning', amount: '~8.5 mdr', amountNum: 8500, source: 'Pensionsmyndigheten; SFB kap 74' },
      { key: 'etablering', amount: '~6.0 mdr', amountNum: 6000, source: 'Arbetsförmedlingen; SFS 2017:584' },
      { key: 'bostadsbidrag', amount: '~5.5 mdr', amountNum: 5500, source: 'Försäkringskassan; SFB kap 95–98' },
      { key: 'sjukAktivitet', amount: '4.1 mdr', amountNum: 4120, source: 'Skr. 2024/25:98, post G2' },
      { key: 'underhallsstod', amount: '~3.0 mdr', amountNum: 3000, source: 'Försäkringskassan; SFB kap 17–19' },
    ],
  },
  {
    catKey: 'migration',
    ...
    totalNum: 16010,
    items: [
      { key: 'uo8', amount: '~10.2 mdr', amountNum: 10170, source: 'Budgetpropositionen 2025, UO 8' },
      { key: 'uo13', amount: '~5.8 mdr', amountNum: 5840, source: 'Budgetpropositionen 2025, UO 13' },
    ],
  },
];
